...
plot(ROE_history(:,2) * a_chief * 1e3, ROE_history(:,1) * a_chief * 1e3, 'b-')
...
plot(ROE_history(:,3) * a_chief * 1e3, ROE_history(:,4) * a_chief * 1e3, 'b-')
...
plot(ROE_history(:,5) * a_chief * 1e3, ROE_history(:,6) * a_chief * 1e3, 'b-')
